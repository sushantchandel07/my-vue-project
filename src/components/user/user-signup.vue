          ...
          <form method="post">
            ...
            >
              ...
              <div class="mb-3">
                <label
                  for="fname"
                  class="form-label pt-4 text-secondary fw-bold fs-6"
                  >First Name</label
                >
                <div class="login-input border d-flex p-2 align-items-center">
                  <img
                    src=""
                    class="login-logo mx-1"
                    alt=""
                    height="21"
                    width="25"
                  />
              ...
              <div class="mb-3">
                ...
                <div class="login-input border d-flex p-2 align-items-center">
                  ...
                  />
                  <img src="" class="ms-auto ps-2" alt=""/>
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <div class="login-input border d-flex p-2 align-items-center">
                  ...
                  />
                  <select
                    class="form-select border-0 fs-5"
              ...
              <div class="mb-1">
                ...
                <div class="login-input d-flex gap-2">
                  ...
                  />
                  <label
                    class="form-check-label text-secondary fw-bold fs-6"
              ...
              <div class="mb-3 form-check pt-3 pb-3">
                <input
                  type="checkbox"
                  class="form-check-input rounded-1 p-2 border border-2 border-secondary"
                  id="exampleCheck18"
                />
                <label
                  class="form-check-label text-secondary fw-bold fs-6 lh-base ps-1 pt-1"
                  for="exampleCheck1"
                  >I have read the
                  <a
                    class="link-dark link-offset-2 link-underline-opacity-50 link-underline-secondary"
                    >Terms & Conditions</a
                  >
                </label>
              </div>
              ...
              <div class="pt-3">
                <p class="text-black fw-bold fs-5">
